...
ALL_REWARDS = [Reward_ARH, Reward_SB_W, Reward_SB_S, Reward_SB_L, Reward_SB_TOT]
#
...
def create_fairness_framework_env(args):
    ...
    print("OBJECTIVES parsed: ", args.objectives)
    ...
    print("OBJECTIVES mapped: ", mapped_ordered_notions)
